...
- 分阶段执行：P0 使用者前置约束 → P1 检索与规则结构还原 → P2 叙事骨架锁定 → P3 制作质检 → P4 裁决清单与口径沉淀；
...
> 使用 `$foreign-legal-ppt`，按照我的 PPT 标准制作一份面向中国管理层的 CFIUS 交易指南。检索并核验截至今天的官方法源；先做前置约束（对象与重点注意方面），给出 2 套汇报结构供我确认后再制作；AI 负责检索与美观，口径判断交给我。
